...
/* harmony import */ var _table_data__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./table-data */ "./src/app/table-data.ts");
...
let AppService = class AppService {
    ...
    getStepDetails() {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(this.stepData.filter(step => step.active));
    }
    getAllStepDetails() {
    ...
    denyRequestDetails(data) {
        this.requestedEmployees.forEach(employee => {
            if (employee.empID === data.empID) {
                ...
                this.approvedEmployees.splice(lodash__WEBPACK_IMPORTED_MODULE_4__["findIndex"](this.approvedEmployees, ['empID', data.empID]), 1);
            }
        });
        return;
    }
    ...
    getEmployees() {
        ...
        this.terminationProcessDetails.forEach(employee => {
            if (this.initiatedEmployeeData[lodash__WEBPACK_IMPORTED_MODULE_4__["findKey"](this.initiatedEmployeeData, (emp) => (emp.empID === employee.empID))].HR.status !== 'Complete') {
                if (lodash__WEBPACK_IMPORTED_MODULE_4__["isEqual"](employee.stepID.filter(item => HRSteps.includes(item)).sort(), HRSteps.sort())) {
                    this.initiatedEmployeeData[lodash__WEBPACK_IMPORTED_MODULE_4__["findKey"](this.initiatedEmployeeData, (emp) => (emp.empID === employee.empID))].HR.status = 'Complete';
                    this.initiatedEmployeeData[lodash__WEBPACK_IMPORTED_MODULE_4__["findKey"](this.initiatedEmployeeData, (emp) => (emp.empID === employee.empID))].HR.color = 'accent';
                }
                else if (employee.stepID.filter(item => HRSteps.includes(item)).length !== 0) {
                    this.initiatedEmployeeData[lodash__WEBPACK_IMPORTED_MODULE_4__["findKey"](this.initiatedEmployeeData, (emp) => (emp.empID === employee.empID))].HR.status = 'In Progress';
                    this.initiatedEmployeeData[lodash__WEBPACK_IMPORTED_MODULE_4__["findKey"](this.initiatedEmployeeData, (emp) => (emp.empID === employee.empID))].HR.color = 'primary';
                }
                else {
                    this.initiatedEmployeeData[lodash__WEBPACK_IMPORTED_MODULE_4__["findKey"](this.initiatedEmployeeData, (emp) => (emp.empID === employee.empID))].HR.status = 'Initiated';
                    this.initiatedEmployeeData[lodash__WEBPACK_IMPORTED_MODULE_4__["findKey"](this.initiatedEmployeeData, (emp) => (emp.empID === employee.empID))].HR.color = 'black';
                }
            }
            if (this.initiatedEmployeeData[lodash__WEBPACK_IMPORTED_MODULE_4__["findKey"](this.initiatedEmployeeData, (emp) => (emp.empID === employee.empID))].IT.status !== 'Complete') {
                if (lodash__WEBPACK_IMPORTED_MODULE_4__["isEqual"](employee.stepID.filter(item => ITSteps.includes(item)).sort(), ITSteps.sort())) {
                    this.initiatedEmployeeData[lodash__WEBPACK_IMPORTED_MODULE_4__["findKey"](this.initiatedEmployeeData, (emp) => (emp.empID === employee.empID))].IT.status = 'Complete';
                    this.initiatedEmployeeData[lodash__WEBPACK_IMPORTED_MODULE_4__["findKey"](this.initiatedEmployeeData, (emp) => (emp.empID === employee.empID))].IT.color = 'accent';
                }
                else if (employee.stepID.filter(item => ITSteps.includes(item)).length !== 0) {
                    this.initiatedEmployeeData[lodash__WEBPACK_IMPORTED_MODULE_4__["findKey"](this.initiatedEmployeeData, (emp) => (emp.empID === employee.empID))].IT.status = 'In Progress';
                    this.initiatedEmployeeData[lodash__WEBPACK_IMPORTED_MODULE_4__["findKey"](this.initiatedEmployeeData, (emp) => (emp.empID === employee.empID))].IT.color = 'primary';
                }
                else {
                    this.initiatedEmployeeData[lodash__WEBPACK_IMPORTED_MODULE_4__["findKey"](this.initiatedEmployeeData, (emp) => (emp.empID === employee.empID))].IT.status = 'Initiated';
                    this.initiatedEmployeeData[lodash__WEBPACK_IMPORTED_MODULE_4__["findKey"](this.initiatedEmployeeData, (emp) => (emp.empID === employee.empID))].IT.color = 'black';
                }
            }
            if ((lodash__WEBPACK_IMPORTED_MODULE_4__["isEqual"](employee.stepID.filter(item => HRSteps.includes(item)).sort(), HRSteps.sort()) || this.initiatedEmployeeData[lodash__WEBPACK_IMPORTED_MODULE_4__["findKey"](this.initiatedEmployeeData, (emp) => (emp.empID === employee.empID))].HR.status === 'Complete')
                && (lodash__WEBPACK_IMPORTED_MODULE_4__["isEqual"](employee.stepID.filter(item => ITSteps.includes(item)).sort(), ITSteps.sort()) || this.initiatedEmployeeData[lodash__WEBPACK_IMPORTED_MODULE_4__["findKey"](this.initiatedEmployeeData, (emp) => (emp.empID === employee.empID))].IT.status === 'Complete')) {
                this.initiatedEmployeeData[lodash__WEBPACK_IMPORTED_MODULE_4__["findKey"](this.initiatedEmployeeData, (emp) => (emp.empID === employee.empID))].SUPER.status = 'Complete';
                this.initiatedEmployeeData[lodash__WEBPACK_IMPORTED_MODULE_4__["findKey"](this.initiatedEmployeeData, (emp) => (emp.empID === employee.empID))].SUPER.color = 'accent';
                this.approvedEmployees[lodash__WEBPACK_IMPORTED_MODULE_4__["findIndex"](this.approvedEmployees, ['empID', employee.empID])].SUPER.status = 'Complete';
                this.approvedEmployees[lodash__WEBPACK_IMPORTED_MODULE_4__["findIndex"](this.approvedEmployees, ['empID', employee.empID])].SUPER.color = 'accent';
            }
                ...
                this.initiatedEmployeeData[lodash__WEBPACK_IMPORTED_MODULE_4__["findKey"](this.initiatedEmployeeData, (emp) => (emp.empID === employee.empID))].SUPER.status = 'In progress';
                this.initiatedEmployeeData[lodash__WEBPACK_IMPORTED_MODULE_4__["findKey"](this.initiatedEmployeeData, (emp) => (emp.empID === employee.empID))].SUPER.color = 'primary';
            }
        });
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(this.initiatedEmployeeData);
    }
    getTerminationProcessDetails(empID) {
    ...
    getAllTerminationProcessDetails() {
    ...
    loginCompleteTerminationProcessDetails(empID, login) {
        if (login === "IT") {
            this.initiatedEmployeeData[lodash__WEBPACK_IMPORTED_MODULE_4__["findKey"](this.initiatedEmployeeData, (emp) => (emp.empID === empID))].IT.status = 'Complete';
            this.initiatedEmployeeData[lodash__WEBPACK_IMPORTED_MODULE_4__["findKey"](this.initiatedEmployeeData, (emp) => (emp.empID === empID))].IT.color = 'accent';
            ...
            this.initiatedEmployeeData[lodash__WEBPACK_IMPORTED_MODULE_4__["findKey"](this.initiatedEmployeeData, (emp) => (emp.empID === empID))].HR.status = 'Complete';
            this.initiatedEmployeeData[lodash__WEBPACK_IMPORTED_MODULE_4__["findKey"](this.initiatedEmployeeData, (emp) => (emp.empID === empID))].HR.color = 'accent';
            this.approvedEmployees[lodash__WEBPACK_IMPORTED_MODULE_4__["findIndex"](this.approvedEmployees, ['empID', empID])].SUPER.status = 'In Progress';
            this.approvedEmployees[lodash__WEBPACK_IMPORTED_MODULE_4__["findIndex"](this.approvedEmployees, ['empID', empID])].SUPER.color = 'primary';
        }
        if (this.initiatedEmployeeData[lodash__WEBPACK_IMPORTED_MODULE_4__["findKey"](this.initiatedEmployeeData, (emp) => (emp.empID === empID))].IT.status === 'Complete'
            && this.initiatedEmployeeData[lodash__WEBPACK_IMPORTED_MODULE_4__["findKey"](this.initiatedEmployeeData, (emp) => (emp.empID === empID))].HR.status === 'Complete') {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Job_Titles", function() { return Job_Titles; });
...
const Job_Titles = ['Supervisor', 'Manager', 'Lead', 'Tech2', 'Admin2', 'Planner1', 'MHTech2'];
const EmployeeData = [
...
//# sourceMappingURL=default~pages-temp1-temp1-module~pages-temp2-temp2-module~pages-temp3-temp3-module-es2015.js.map